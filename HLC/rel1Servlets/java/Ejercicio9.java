...
public class Ejercicio9 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("Cadena 1: " + cadena1 + "<br>");
            out.println("Cadena 2: " + cadena2 + "<br>");
            
            if (cadena1.equalsIgnoreCase(cadena2))
                out.println("Las cadenas introducidas contienen el mismo texto");
            else
                out.println("Las cadenas introducidas no contienen el mismo texto");
